...
// SceneManager.h
// ==============
// Manages preparing and rendering of 3D scenes, including shader settings.
//
...
public:
	...
	// Student-customizable scene methods
	void PrepareScene();
	void RenderScene();

	// Sends scene light uniforms to the shader (called from RenderScene)
